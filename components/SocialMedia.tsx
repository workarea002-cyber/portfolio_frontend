...
const SocialMedia = () => {
  return (
    <div className="hidden sm:flex justify-end items-center flex-col p-4">
      <div className="cursor-pointer w-10 h-10 rounded-full bg-white my-1 border border-lightGray flex-center transition-all duration-300 ease-in-out hover:bg-secondary hover:border-secondary group">
